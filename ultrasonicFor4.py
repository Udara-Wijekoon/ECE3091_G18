...
if __name__ == '__main__':
    try:
        while True:
            ...
            print ("Measured Distance = %.1f cm" % dist_front)
            print ("Measured Distance = %.1f cm" % dist_back)
            print ("Measured Distance = %.1f cm" % dist_left)
            print ("Measured Distance = %.1f cm" % dist_right)
            time.sleep(1)
